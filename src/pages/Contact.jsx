      ...
      <div className="flex gap-x-8 justify-center">
        <section className="flex flex-col w-full max-w-[340px] py-10 px-8 border-[3px] border-gray-300">
          <span className="pb-8 mb-8 border-b-[2px] border-gray-600">
            ...
            <p className="text-[14px] mb-2 leading-[21px]">We are available 24/7, 7 days a week.</p>
          ...
          <span className="">
            ...
            <p className="text-[14px] mb-2 leading-[21px]">Fill out our form and we will contact you within 24 hours.</p>
        ...
        <form className="py-10 px-8 flex flex-col border-[3px] border-gray-300">
          <div className="flex items-center gap-x-4 mb-8">
            <input className="outline-none bg-slate-100 w-full rounded-sm pl-2 max-w-[235px] h-[50px]" type="text" placeholder="Your Name *" />
            <input className="outline-none bg-slate-100 w-full rounded-sm pl-2 max-w-[235px] h-[50px]" type="text" placeholder="Your Email *" />
            <input className="outline-none bg-slate-100 w-full rounded-sm pl-2 max-w-[235px] h-[50px]" type="text" placeholder="Your Phone *" />
          </div>
          <textarea className="pl-2 mb-8 h-[207px] w-full bg-slate-100" placeholder="Your Massage " cols="30" rows="10"></textarea>
