...
import { close_btn, product1 } from "../assets"
        ...
        <li  className="group flex items-center justify-between px-10 py-6 border-[4px] border-gray-200 rounded-md backetItem" >
            <span className="flex items-center gap-x-5">
                <small className="relative">
                    <img src={product1} className='w-12 h-12' />
                    <small onClick={() => console.log('delete in backet')} className="group-hover:flex hidden items-center justify-center w-5 h-5 bg-[#DB4444] rounded-full absolute top-[-7px] left-[-10px]">
            ...
            <span className="flex items-center flex-col gap-y-1">
                <button onClick={plusFn}><IoIosArrowUp /></button>
                <button onClick={minusFn}><IoIosArrowDown /></button>
            </span>
            </span>
            <p>$650</p>
        </li>
