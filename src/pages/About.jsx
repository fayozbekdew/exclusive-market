...
//?react-multi-carousel for caousel element
...
const aboutDb = [
  {
    ...
    imgWhite: marketWhite,
    imgBlack: marketBlack,
  },
  {
    name: "33k ",
  ...
  },
  {
    ...
    imgWhite: moneyBagWhite,
    imgBlack: moneyBagBlack,
  },
];
const employee = [
  {
...
//?responsive code for carousel effect
  const responsive = {
    superLargeDesktop: {
    ...
    <div className="myContainer pb-[142px]">
      ...
      <div className="h-[609px] flex items-center justify-between pb-32">
        <div className="w-[525px]">
          <h1 className="text-[54px] font-medium leading-[64px] tracking-[3.24px]">
            Our Story
          </h1>
          <p className="text-[16px] w-full max-w-[505px] leading-[26px] mt-10 mb-6">
          ...
          <p className="text-[16px]  w-full max-w-[505px] leading-[26px] font-normal">
        ...
        {aboutDb.map((item) => {
          return (
            <li
              ...
              className={` w-[270px] h-[230px] transition-all flex items-center group hover:bg-[#DB4444] hover:text-white hover:scale-[1.01] justify-center flex-col rounded-md border aboutItem`}
            ...
            >
              <small className="flex items-center justify-center h-[70px] w-[70px] border-[8px] border-gray-400 rounded-full bg-black mb-6 group-hover:bg-white group-hover:border-gray-200">
                <img
                  src={`${hover ? item.imgBlack : item.imgWhite}`}
                  className={` h-10 w-10 `}
                  alt=""
                />
              </small>
              <h2 className="text-[32px] font-bold leading-[30px] tracking-[1.28px] mb-2">
                {item.name}
              </h2>
        ...
        {employee.map((employee) => {
          return (
            <div key={crypto.randomUUID()} className="w-[350px] h-[564px]">
              ...
              <h3 className="text-[32px] font-medium tracking-[1.28px] mt-8">
                {employee.name}
              </h3>
      ...
      <ul className="flex items-center justify-center gap-x-[88px] mt-32">
        <li className="w-[250px] h-[160px] flex items-center justify-center flex-col">
          <img
            src={delivery}
            className="w-16 h-16 bg-black rounded-full border-gray-400 border-[8px]"
            alt=""
          />
          <h3 className="text-[20px] font-semibold mt-6 leading-[28px]">
